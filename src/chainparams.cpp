...
public:
    CMainParams() {
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_ALERTS].bit = 2;
        consensus.vDeployments[Consensus::DEPLOYMENT_ALERTS].nStartTime = 999999999999L;
        consensus.vDeployments[Consensus::DEPLOYMENT_ALERTS].nTimeout = Consensus::BIP9Deployment::NO_TIMEOUT;
...
public:
    CTestNetParams() {
        ...
        // Deployment of Alerts
        consensus.vDeployments[Consensus::DEPLOYMENT_ALERTS].bit = 2;
        consensus.vDeployments[Consensus::DEPLOYMENT_ALERTS].nStartTime = 0;
        consensus.vDeployments[Consensus::DEPLOYMENT_ALERTS].nTimeout = Consensus::BIP9Deployment::NO_TIMEOUT;
